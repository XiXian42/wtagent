...
const chinese = {
  ...
  "hero.title2": "本地编程助手。",
  "hero.turn": "把",
  "hero.chatgpt": "变成 Codex 式编程助手。",
  "hero.claude": "变成 Claude Code 式编程助手。",
  "hero.also": "同时支持",
  "hero.lede": "在终端里交代任务，让网页 AI 读取本地文件、修改代码、运行测试。",
  "hero.start": "在本地试用",
  "hero.watch": "看看怎么做",
...
const ui = {
  en: {
    ...
    home: "WTAgent home",
    title: "WTAgent — ChatGPT, Claude & more web AIs for local coding",
    description: "Turn ChatGPT Web into a Codex-style coding agent. Turn Claude Web into a Claude Code-style coding agent. Also supports DeepSeek, Gemini, Grok, Kimi and GLM. Independent CLI; no API key required.",
    shareTitle: "WTAgent — Turn web chats into coding agents",
    shareDescription: "Turn ChatGPT Web into a Codex-style coding agent. Turn Claude Web into a Claude Code-style coding agent. Also supports DeepSeek, Gemini, Grok, Kimi and GLM. Independent CLI; no API key required.",
    shareImageAlt: "WTAgent: ChatGPT Web to Codex-style coding; Claude Web to Claude Code-style coding. Also supports DeepSeek, Gemini, Grok, Kimi and GLM. Independent CLI, no API key.",
  },
  zh: {
    copied: "已复制",
    copyCommand: "复制命令：",
    ...
    mapping: "编程工作流对照",
    home: "WTAgent 首页",
    title: "WTAgent — 把 ChatGPT、Claude 等网页 AI 变成本地编程助手",
    description: "把 ChatGPT Web 变成 Codex 式编程助手，把 Claude Web 变成 Claude Code 式编程助手。同时支持 DeepSeek、Gemini、Grok、Kimi、GLM。使用你的网页账号，独立 CLI，无需 API Key。",
    shareTitle: "WTAgent — 把网页聊天变成本地编程助手",
    shareDescription: "把 ChatGPT Web 变成 Codex 式编程助手，把 Claude Web 变成 Claude Code 式编程助手。同时支持 DeepSeek、Gemini、Grok、Kimi、GLM。使用你的网页账号，独立 CLI，无需 API Key。",
    shareImageAlt: "WTAgent：把 ChatGPT Web 变成 Codex 式编程助手，把 Claude Web 变成 Claude Code 式编程助手。同时支持 DeepSeek、Gemini、Grok、Kimi、GLM。独立 CLI，无需 API Key。",
  },
};
